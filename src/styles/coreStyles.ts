...
export const typography = () => {
  ...
  const styles = StyleSheet.create({
    ...
    bodyCompactMedium_Bold: {
      ...baseFontStyle.bodyCompactMedium,
      fontFamily: "Inter-SemiBold",
      fontWeight: "600",
    },
    bodyCompactSmall_Bold: {
      ...baseFontStyle.bodyCompactSmall,
      fontFamily: "Inter-Medium",
    },
    bodyCompactXsmall_Bold: {
      ...baseFontStyle.bodyCompactXsmall,
      fontFamily: "Inter-Medium",
    },
  });
